#!/usr/bin/env python3
"""
Запуск бота в простом режиме без базы данных
"""
...
os.environ['DATABASE_URL'] = 'postgresql+asyncpg://postgres:postgres@localhost:5432/aptechka'
...
async def main():
    ...
    try:
        logger.info("🚀 Запуск Telegram бота в простом режиме...")
